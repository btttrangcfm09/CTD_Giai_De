...
int emitPW(CodeBlock* codeBlock) { return emitCode(codeBlock, OP_PW, DC_VALUE, DC_VALUE); } // đề 2020 bài 1
...
void printInstruction(Instruction* inst) {
  ...
  case OP_PW: printf("PW"); break; // đề 2020 bài 1
...
void sprintInstruction(char* s, Instruction* inst) {
  ...
  case OP_PW: sprintf(s,"PW"); break; // đề 2020 bài 1
